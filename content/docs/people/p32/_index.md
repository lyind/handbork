...
---
This is the placeholder for the documentation of P32. As the entire concept is still WIP, only current Google docs will be linked. In a future you can find a proper documentation.
